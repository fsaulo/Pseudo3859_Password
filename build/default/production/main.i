...
# 18 "/opt/microchip/mplabx/v5.45/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8/pic/include/xc.h"
...
# 52 "/opt/microchip/mplabx/v5.45/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8/pic/include/proc/pic16f887.h"
...
# 30 "/opt/microchip/mplabx/v5.45/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8/pic/include/pic.h"
...
# 114 "/opt/microchip/mplabx/v5.45/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8/pic/include/eeprom_routines.h"
extern void eeprom_write(unsigned char addr, unsigned char value);
extern unsigned char eeprom_read(unsigned char addr);


# 91 "/opt/microchip/mplabx/v5.45/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8/pic/include/pic.h"
...
if (!PORTDbits.RD1) nreg = 0;
}

PORTDbits.RD1 = PORTDbits.RD0;


preg = PORTDbits.RD1 ? preg : 0U;
...
if (PORTCbits.RC0 == 0 && PORTCbits.RC1 == 0 && PORTCbits.RC2 == 0 && PORTCbits.RC3 == 0 && *flag == 0) {
*flag = 1U;
}
...
switch ( PORTDbits.RD1 ) {



case 0:
if (PORTCbits.RC0 == 1U && *flag == 1) {
_delay((unsigned long)((50)*(20000000/4000000.0)));
if (PORTCbits.RC0 == 1) {
...
PORTB = aux_bus[pdisp];
mux_display(pdisp);
_delay((unsigned long)((800)*(20000000/4000000.0)));
}
pr++;
}
